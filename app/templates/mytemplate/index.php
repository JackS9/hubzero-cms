				...
				<div id="splash">
					<div class="inner-wrap">
						...
						<header id="masthead" role="banner">
							...
							<h1>
								<a href="<?php echo Request::root(); ?>" title="<?php echo Config::get('sitename'); ?>" style="padding:6px 0;">
									<img alt="Aquavit" src="/app/site/media/images/aquavit-logo.png" style="width:143px;height:36px;" title="Aquavit">
								</a>
							</h1>
