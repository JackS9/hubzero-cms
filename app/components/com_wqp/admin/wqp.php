<?php
namespace Components\Wqp\Admin;
...
if (!\User::authorise('core.manage', 'com_wqp'))
{
	return \App::abort(404, \Lang::txt('JERROR_ALERTNOAUTHOR'));
}

// The "Portal" model pulls in all other models used throughout the component.
//
...
require_once(dirname(__DIR__) . DS . 'models' . DS . 'portal.php');
...
// we forcefully set the controller name to our default ("stations").
//
...
$controllerName = \Request::getCmd('controller', 'stations');
if (!file_exists(__DIR__ . DS . 'controllers' . DS . $controllerName . '.php'))
{
	$controllerName = 'stations';
}
...
// stations and results, we'll add a menu item for each controller.
\Submenu::addEntry(
	\Lang::txt('COM_WQP_STATIONS'),
	\Route::url('index.php?option=com_wqp&controller=stations'),
	($controllerName == 'stations')
);
\Submenu::addEntry(
	\Lang::txt('COM_WQP_RESULTS'),
	\Route::url('index.php?option=com_wqp&controller=results'),
...
//
// So, for a controller with the name of "portal" in this component:
//
// /com_wqp
//    /site
//        /controllers
//            /portal.php
//
// ... we get the final class name of "Components\Wpg\Site\Controllers\Portal".
//
