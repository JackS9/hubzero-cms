...
Document::setTitle(Lang::txt('COM_WQP'));
...
<section class="main section">
	<form class="section-inner" action="<?php echo Route::url('index.php?option=' . $this->option); ?>" method="get">
		<p><a href="<?php echo Route::url('index.php?option=' . $this->option . '&controller=results'); ?>"><?php echo Lang::txt('COM_WQP_RESULTS'); ?></a></p>
		<p><a href="<?php echo Route::url('index.php?option=' . $this->option . '&controller=stations'); ?>"><?php echo Lang::txt('COM_WQP_STATIONS'); ?></a></p>
	</form>
</section>
